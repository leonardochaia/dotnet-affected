...
MinimumVisualStudioVersion = 10.0.40219.1");
            ...
            {
                sb.Append(@"
Project(""").Append(project.ProjectTypeGuid).Append(@""") = """).Append(project.Name).Append(@""", """)
                    .Append(project.Path).Append(@""", """).Append(project.Guid).AppendLine(@"""");
                sb.AppendLine(@"
EndProject");
            }
            ...
            sb.Append("\t\t").Append("Debug|AnyCPU").Append(" = ")
