...
| [DotnetAffectedFromRef](./Examples/from-ref.props)                      | `Input`<br/>Property  | string    | A branch or commit to compare the working directory against. <br/> **Default**: HEAD (when value is null/empty string)                                                                                                                                                                                               |
| [DotnetAffectedUncommitted](./Examples/from-ref.props)                  | `Input`<br/>Property  | string    | How much of the working directory counts on top of the commits since **FromRef**: `All`, `Staged` or `None`. <br/> **Default**: All (when value is null/empty string)                                                                                                                                                |
| DotnetAffectedToRef                                                     | `Input`<br/>Property  | string    | **OBSOLETE, removed in v8**. The commit the working directory is checked out at. Projects are discovered and evaluated from the working directory, so any other value is refused. <br/> **Default**: Empty                                                                                                            |
